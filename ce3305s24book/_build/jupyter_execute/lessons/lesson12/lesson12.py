...
# 
# Is a tool used to guide expermental design and practice
# 
# #### Similitude 
# 
# Is a tool used to scale laboratory results to full-scale situations.
# Many practical problems have unusual enough geometry that studies on a replica at small scale are used to predict flow patterns, pressure variation, frictional losses.
# 
