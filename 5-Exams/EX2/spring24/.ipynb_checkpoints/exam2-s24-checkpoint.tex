...
\noindent\rule{\linewidth}{0.4pt}
\clearpage
\item A firehose on a boat is producing a 100 mm. diameter, horizontal, water jet with a speed of $V=100$ kph. The boat is held stationary by a cable attached to a pier. The water temperature is 20$^o$C. 

Determine: 
\begin{enumerate}
\item The tension in the cable in Newtons
\end{enumerate}
%~\newline
\end{enumerate}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
