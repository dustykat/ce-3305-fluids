...
# 
# 3. DF Elger, BC Williams, Crowe, CT and JA Roberson, *Engineering Fluid Mechanics 10th edition*, John Wiley & Sons, Inc., 2013. [http://54.243.252.9/ce-3305-webroot/3-Readings/EFM-18.pdf](http://54.243.252.9/ce-3305-webroot/3-Readings/EFM-18.pdf)
# 
...
# ## Videos
# 
# - [Direct-Step (Specify Depth, Find Distances) Example (by-hand) (YouTube)](https://www.youtube.com/watch?v=P6lluipDzAA)
# - [Standard-Step (Specify Distance, Find Depths) Example(s) (YouTube)](https://www.youtube.com/watch?v=xOxSmy2mo4I)

# ## Lesson Outline
# - Water Surface Profiles
# - Finite Differences Backwater Curve
# - Finite Differences Frontwater Curve
